export default {
  up: async (q) => {
    ...
    await q.sequelize.query(
      "CREATE TABLE IF NOT EXISTS `Users` (`id` CHAR(36) NOT NULL , `phone_number` VARCHAR(30) NOT NULL, `first_name` VARCHAR(255), `last_name` VARCHAR(255), `registration_number` VARCHAR(8) NOT NULL, `last_connected` DATETIME, `event_id` CHAR(36) NOT NULL, PRIMARY KEY (`id`), FOREIGN KEY (`event_id`) REFERENCES `Events` (`id`));"
    );
    await q.sequelize.query(
